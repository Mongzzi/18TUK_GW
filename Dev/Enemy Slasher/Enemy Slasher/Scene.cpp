...
#define TEXTURES  15
	...
	m_pShaderManager->CreateCbvSrvDescriptorHeaps(pd3dDevice, 0, TEXTURES, ShaderType::CTextureShader); // text ���̴��� ������ ���� �ڵ鰪�� ��������� ������ ����
...
//
//	m_pShaderManager->CreateCbvSrvDescriptorHeaps(pd3dDevice, 0, TEXTURES, ShaderType::CUITextureShader); // text ���̴��� ������ ���� �ڵ鰪�� ��������� ������ ����
