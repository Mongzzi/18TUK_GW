...
public:
	...
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera, bool bRenderAABB, int nPipelineState = 0);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CAABBShader : public CStandardShader
{
public:
	CAABBShader();
	virtual ~CAABBShader();
